...
<style>
  .error-section {
    padding: 120px 20px;
    background: radial-gradient(circle at center, #fff, #f2f2f2);
    color: #222;
    text-align: center;
  }
