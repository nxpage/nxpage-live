...
<style>
  .shadow-request-section {
    padding: 100px 20px;
    background: linear-gradient(to bottom, #fdfdfd, #f0f5ff);
    text-align: center;
  }
